...
export class Settings extends LitElement {
    ...
    public render() {
        ...
        <md-filled-text-field class="video-format-input" label="frame rate" type="number" min="1" step="1" suffix-text="fps" ?disabled=${live(this.config.videoFormat.recordingMode === 'audio-only')} .value=${live(this.config.videoFormat.frameRate)} @input=${this.updateProp('videoFormat', 'frameRate')}></md-filled-text-field>
